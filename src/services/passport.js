...
const localSignup = new LocalStrategy(localOptions, function (email, password, done) {
  ...
  if (!email || !password) {
    ...
    return done(null, false, { message: 'You must provide email and password' });
  }
...
//     // models.User.findOrCreate({ where: { googleId: profile.id } }).then(function (user) {
